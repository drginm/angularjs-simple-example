 ...
 */
package co.dlighthouse.aem.angularjs.simpleexample.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "co.dlighthouse.aem.angularjs.simpleexample.it.tests";
